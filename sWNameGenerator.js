...
let species = ['human', 'twi`lek', 'pantoran', 'gamorrean', 'hutt', 'ithorian', 'trandoshan', 'bith', 'dathomirian', 'nemoidian','zabrak', 'mon cal', 'quarren', 'ugnaut', 'sullustan', 'duros', 'kel dor', 'bothan', 'rodian', 'gungan', 'togruta', 'mirialan', 'weequay']
let occupations = ['freighter pilot', 'starfighter pilot', 'assassin', 'luxury starline concierge', 'waiter', 'waitress', 'rancor trainer', 'podracer', 'starfighter racer', 'minor royal', 'senatorial attache', 'dealer of valuable antiquities', 'pirate', 'liberator of ancient wonders', 'starship magnate', 'industrialist', 'aristocrat', 
'miner', 'ship scrapper', 'scrapyard owner', 'nerf herder', 'private investigator', 'bounty hunter', 'spice dealer', 'crime lord', 'exotic dancer', 'mercenary', 'professional soldier', 'smuggler', 'enforcer', 'marshall', 'cantina owner', 'bar tender', 'restaurant owner', 'cook', 'chef', 'brewer', 'distiller', 'sex worker', 'spy', 'merchant', 'moisture farmer', 'bacta farmer', 'mandalorian warrior', 'meiloorun farmer', 'fisher', 'big game hunter', 'singer', 'holo star', 'jizz musician', 'navigator', 'starship mechanic', 'engineer', 'local legislator', 'senator', 'corpo', 'planetary security agent', 'spicer']
let planets = ['from coruscant', 'visiting kashhyyk', 'being hunted on transdosha', 'from pantora', ' from bith', 'working on bespin', 'from lothal', 'from corellia', 'passing through ryloth', 'from pabu', 'visiting felucia', 'stranded on jakku', 'from galitan', 'working on cato nemoidia', 'visiting stewjon', 'stranded on tattooine', 'passing through mon calimari', 'from hosnian prime', 'working on canto bight', 'from dantooine', 'working on sullust', 'from garel', 'from alderaan', 'from naboo', 'visiting mandalore', 'from ferrix', 'from raxus prime', 'from onderon' ]
