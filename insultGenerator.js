...
let action = ['eat', 'kick', 'grate', 'grind', 'pound', 'punt','jump over','dig', 'spin', 'juggle', 'throw up','spill', 'climb', 'throw', 'flip', 'slip on', 'trip over', 'find', 'run over', 'gobble', 'gargle', 'fumble', 'caress', 'swallow','inhale', 'fart on', 'pee on', 'pack up', 'squeeze', 'press', 'push', 'chauffeur']
